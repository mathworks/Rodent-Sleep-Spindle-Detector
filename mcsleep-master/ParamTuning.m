...
params.K = 2034;     % Set it to sampling Frequenty
params.O = 1017;     % Ideally set it to 50% overlapping
...
[params.data, header] = lab_read_edf('C:\Users\Chezinu\Downloads\_rats1_8-180306-000004_RAT5.edf');
